...
export default function About() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 text-gray-800">
      ...
      <p className="text-lg leading-relaxed mb-6">
        New townsfolk will be joining in regularly, so check back often for the
        latest additions! If there's a particular character you'd like to see
        more of, don't hesitate to contact me with your suggestions in the
        footer.
      </p>
      ...
      <p className="text-lg leading-relaxed mb-6">
        SVGs are infinitely scalable, editable, and perfect for digital use. The
        paid SVGs are cleaned, organized, and optimized for professional use —
        unlike the PNG/JPG previews; which are direct exports from the vectors,
        at an approximate height of 700px.<br></br>
      ...
      <p className="text-lg leading-relaxed mb-6">
        You can use these characters for almost anything, specially if you paid
        for the SVGs. But <b>remember!</b> You must follow the{" "}
      ...
      <p className="text-lg leading-relaxed mb-6">
        Before buying an SVG, if you are part of a non-profit organization for a
        good cause, or trans, or non-binary, or on a tight budget, please
      ...
      <p className="text-lg leading-relaxed mb-6">
        ...
        Every purchase contributes to my personal (<small>and my cats</small>)
        financial freedom.
      </p>
