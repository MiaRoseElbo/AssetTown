...
export default function AssetPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{`${asset.name}`} — Free Character Asset | Asset Town</title>
        <meta
          name="description"
          content={`Download ${asset.name}, a free ${asset.character} character asset for marketin and creative projects.`}
        />
      </Helmet>
